...
const PrivacyPolicy = () => {
  return (
    <Layout>
      Privacy Policy Last updated: February 12, 2023 This Privacy Policy
      ...
      or in plural. Definitions For the purposes of this Privacy Policy: Account
      means a unique account created for You to access our Service or parts of
      our Service. Affiliate means an entity that controls, is controlled by or
      ...
      Agreement) refers to Code Artist, Jamielnik, 13-230 Lidzbark. Cookies are
      ...
      that website among its many uses. Country refers to: Poland Device means
      ...
      the duration of a page visit). Website refers to Code Artist, accessible
      from https://code-artist1.gitlab.io/code-artist-gatsby-front-end/ You
      ...
      and last name Phone number Usage Data Usage Data Usage Data is collected
      ...
      You access the Service by or through a mobile device. Tracking
      ...
      Your web browser. Learn more about cookies on the Free Privacy Policy
      ...
      provide You with services available through the Website and to enable You
      to use some of its features. They help to authenticate users and prevent
      fraudulent use of user accounts. Without these Cookies, the services that
      You have asked for cannot be provided, and We only use these Cookies to
      provide You with those services. Cookies Policy / Notice Acceptance
      Cookies Type: Persistent Cookies Administered by: Us Purpose: These
      Cookies identify if users have accepted the use of cookies on the Website.
      ...
      every time You use the Website. For more information about the cookies we
      use and your choices regarding cookies, please visit our Cookies Policy or
      ...
      their implementation. To provide You with news, special offers and general
      ...
      You have opted not to receive such information. To manage Your requests:
      To attend and manage Your requests to Us. For business transfers: We may
      ...
      personal information in the following situations: With Service Providers:
      We may share Your personal information with Service Providers to monitor
      and analyze the use of our Service, to contact You. For business
      ...
      can contact us: By email: codeartist.net@gmail.com By visiting this page
      on our website:
      https://code-artist1.gitlab.io/code-artist-gatsby-front-end/
    </Layout>
  );
};
